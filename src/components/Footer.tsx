            ...
            <div className="flex items-center gap-3 mt-6">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.name}
                  className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:bg-accent hover:text-foreground transition-colors duration-200"
                >
                  {s.icon}
                </a>
              ))}
              ...
              {[
                ...
                <li key={link.label}>
                  <button
                    ...
                    className="text-sm text-white/60 hover:text-accent transition-colors duration-200 font-medium"
                  >
                    {link.label}
                  </button>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={prog}>
                  <span className="text-sm text-white/60 font-medium">{prog}</span>
                </li>
              ))}
            </ul>
          </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/40 text-center sm:text-left">
            © {year} AKWA IBOM PILLARS EMPOWERMENT COOPERATIVE ASSOCIATION. All Rights Reserved.
          </p>
          <div className="flex items-center gap-5">
            <a href="#" className="text-xs text-white/40 hover:text-white/70 transition-colors font-medium">
              Privacy
            </a>
            <a href="#" className="text-xs text-white/40 hover:text-white/70 transition-colors font-medium">
              Terms
